...
export enum IntroductionScreeningStatus {
    Pending = "pending",
    Accepted = "accepted",
    Rejected = "rejected"
}

export const IntroductionScreeningStatusColors = {
    [IntroductionScreeningStatus.Pending]: 0x8a969f,
    [IntroductionScreeningStatus.Accepted]: 0x0095ff,
...
export const initialRPGDoc: RpgDocument = {
...
export const initialEconomyDoc: EconomyDocument = {
...
export const initialBookDoc: BookDocument = {
...
export const messages = {
    ...
    targetNoWallet: (targetDisplayName: string) => ({
        embeds: [
            new EmbedBuilder()
                .setTitle("No Wallet")
                .setColor(messageTypeColors.Failure)
    ...
    wagerClosed: (description: string) => ({
        embeds: [
            new EmbedBuilder()
    ...
    wagerResults: (description: string) => ({
        embeds: [
            new EmbedBuilder()
